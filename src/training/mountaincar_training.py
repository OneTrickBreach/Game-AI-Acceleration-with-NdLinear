...
from src.utils.experiment_config import MOUNTAINCAR_CONFIG
from src.utils.model_utils import save_model, load_model # Import load_model

def train_mountaincar():
    """Trains DQN agents on the MountainCar-v0 environment."""
    print("Training agents on MountainCar-v0 environment...")
    ...
    # Define model paths
    baseline_model_path = "models/baseline/mountaincar_dqn_baseline.pth"
    ndlinear_model_path = "models/ndlinear/mountaincar_dqn_ndlinear.pth"
    ...
    print("\nMountainCar-v0 training complete.")
