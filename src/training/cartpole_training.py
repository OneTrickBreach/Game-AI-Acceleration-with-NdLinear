...
from src.utils.experiment_config import CARTPOLE_CONFIG
from src.utils.model_utils import save_model, load_model # Import load_model

def train_cartpole():
    """Trains DQN agents on the CartPole-v1 environment."""
    print("Training agents on CartPole-v1 environment...")
    ...
    # Define model paths
    baseline_model_path = "models/baseline/cartpole_dqn_baseline.pth"
    ndlinear_model_path = "models/ndlinear/cartpole_dqn_ndlinear.pth"
